...
The $Z$ is where the experiment takes place. This value is passed to the standard error function for use as the denominator. We will asses the distribution of the test statistic when different values for $Z$ are used.
