# ===================================================
# Estimating value functions using the PMCC algorithm
# ===================================================
...
# Parallel Monte Carlo Control Algorithm
def sbbi(tp, healthy, Q_hat_next, Q_hat_rv, Q_hat70_next, discount, obs):
    ...
    prob = prob/prob.sum(axis=1)[:, np.newaxis] # making sure trantiotion probabilities sum up to 1 (at each scenario, decision epoch, and action)
